...
if record_vid==True:
    writer = cv2.VideoWriter('trackfish_output_sideview.mp4', fourcc, fps,(height,width),True)
...
def detect(img):
    ...
    rects = cascade.detectMultiScale(img, scaleFactor=1.7, minNeighbors=24,  minSize=(20,20),maxSize=(200,100),flags=cv2.CASCADE_SCALE_IMAGE)
